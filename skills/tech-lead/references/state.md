# State — who writes what, and the shape of what they write

Two halves of one question. Part 1 is ownership: every artifact, its single writer, and its
readers. Part 2 is the schema of `harness-run.md` itself, which the kernel writes and reads and
therefore cites by path.

---

# Part 1 — State ownership
