...
Full design, findings and follow-ups: [`docs/plan/day1-day2-measurement.md`](../docs/plan/day1-day2-measurement.md).
...
deliberately out of scope (`docs/plan/day1-tier1-plan.md` §6).
...
- **Headroom on `claude-sonnet-5` for the four skills that ceiling on it.** `task-executor`,
  ...
  property of task **and model jointly**. See `docs/plan/day1-tier1-plan.md` §5.
