...
Estimated: 1 build round | Actual: ~
...
|------|-----------------|-----------------|
| [[usecases/UC-CompleteTodo]] | [description] | [what would have helped] |

**Specs that were well-written:**
- [[contracts/todo-store.contract]] — [why it worked well]
