...
the specific thing that replaces it. Each line is a guard in `tests/structural/25-scheduler.mjs`,
...
4. `tests/structural/25-scheduler.mjs`: the guards, each verified by re-introducing its defect.
